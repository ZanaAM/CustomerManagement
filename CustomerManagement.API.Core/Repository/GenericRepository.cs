...
namespace CustomerManagement.API.Core.Repository
{
    public class GenericRepository<T> : IGenericRepository<T> where T : class
    {
        ...
        public GenericRepository(CustomerManagementDbContext context, IMapper mapper)
        {
        ...
        public async Task<PaginatedResult<TResult>> GetAllAsync<TResult>(QueryParameters queryParameters)
        {
